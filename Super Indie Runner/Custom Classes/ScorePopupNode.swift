...
class ScorePopupNode: PopupNode {
    ...
    func addScoreLabel() {
        ...
        scoreLabel.zPosition = GameConstants.ZPoisitions.hudZ
        addChild(scoreLabel)
    }
    ...
    func addStars() {
        for i in 0...2 {
            ...
            empty.zPosition = GameConstants.ZPoisitions.hudZ
            
            star.size = empty.size
            star.position = empty.position
            star.zRotation = empty.zRotation
            star.zPosition = GameConstants.ZPoisitions.hudZ + 1
    ...
    func addCoins(count: Int) {
        ...
        coin.zPosition = GameConstants.ZPoisitions.hudZ
        addChild(coin)
        ...
        coinLabel.zPosition = GameConstants.ZPoisitions.hudZ
        addChild(coinLabel)
    }
